...
export function HowItWorks() {
  return (
    <section className="container py-10">
      <p className="font-display mb-6 text-center text-2xl font-extrabold">How It Works</p>
      <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
        {STEPS.map((s) => (
          ...
          >
            <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-vipNavy-800 to-vipNavy-900 font-display text-lg font-extrabold text-[#f0c988]">
              {s.n}
            </div>
